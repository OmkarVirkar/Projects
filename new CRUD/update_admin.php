...
{    
  ...
  {  
    ...
    $query = "UPDATE student SET Sirname = '$new_sname',Passwd = '$new_Passwd',class = '$new_class',RollNo = '$new_roll' WHERE RollNo = '$roll' ";
    $res = mysqli_query($conn, $query);
    if($res)
    {   
        $login = new Login($name,$new_Passwd); 
        $login->process();  
